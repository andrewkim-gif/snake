 ...
 * ProposalList + VoteInterface 연결
 * 상태 필터: ALL | VOTING | PASSED | REJECTED | EXECUTED
...
const MOCK_PROPOSALS: Proposal[] = [
  {
    ...
    description:
      'Lowering the national tax rate will attract more agents and increase overall economic activity in the Korean arena.',
    proposalType: 'tax',
    forVotes: 124.5,
    againstVotes: 46.2,
  ...
  },
  {
    ...
    description:
      'Establish a bilateral trade corridor reducing cross-border token transfer fees by 50%.',
    proposalType: 'trade',
    forVotes: 210.3,
    againstVotes: 21.1,
  ...
  },
  {
    ...
    description:
      'Boost the national defense multiplier to strengthen arena combat effectiveness for all US-aligned agents.',
  ...
  },
  {
    ...
    description:
      'Allocate 10% of the Korean national treasury to increase staking APR for $KOR holders.',
  ...
  },
  {
    ...
    description:
      'Grant temporary diplomatic immunity to UK agents during cross-border raids for 24 hours.',
    proposalType: 'other',
    forVotes: 67.3,
    againstVotes: 12.1,
  ...
  },
  {
    ...
    description:
      'Expand the Japanese national arena capacity from 100 to 200 concurrent players to accommodate growing demand.',
    proposalType: 'other',
    forVotes: 198.4,
    againstVotes: 5.6,
...
function GovernancePageInner() {
  ...
  const filteredProposals = useMemo(() => {
    ...
    // 국가 필터
    if (countryCode) {
      list = list.filter((p) => p.iso3 === countryCode.toUpperCase());
    }
  ...
  return (
    <div>
      ...
      {/* 모바일: 2-col → 1-col, VoteInterface를 모달처럼 표시 */}
      <style>{`
