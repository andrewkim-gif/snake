...
// Tome 타입별 아이콘 이모지 (MC 스타일 텍스트로 대체)
...
export function LevelUpOverlay({ levelUp, onChoose }: LevelUpOverlayProps) {
  ...
  const timeoutSeconds = timeoutTicks / 20; // 20Hz tick rate
    ...
    >
      ...
      {!isTome && choice.currentLevel !== undefined && choice.currentLevel > 0 && (
        <div style={{
          ...
          fontSize: '0.3rem',
          color: '#5B8DAD',
          backgroundColor: 'rgba(91,141,173,0.15)',
          padding: '2px 6px',
        }}>
