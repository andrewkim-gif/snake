...
export function XPBar({ level, xp, xpToNext }: XPBarProps) {
  ...
  return (
    <div style={{
      ...
      zIndex: 15, display: 'flex', alignItems: 'center', pointerEvents: 'none',
    }}>
      ...
      <div style={{
        position: 'relative', zIndex: 1, fontFamily: pixelFont,
        fontSize: '0.35rem', color: MC.textGold, paddingLeft: '8px',
      ...
      <div style={{
        position: 'relative', zIndex: 1, fontFamily: pixelFont,
        fontSize: '0.25rem', color: MC.textSecondary, marginLeft: 'auto', paddingRight: '8px',
        textShadow: '1px 1px 0 rgba(0,0,0,0.8)',
      }}>
